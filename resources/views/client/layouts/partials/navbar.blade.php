                        ...
                        <form id="searchForm">
                            <div style="position: relative;">
                                <div class="input-group">
                                    <input type="text" id="searchInput" class="form-control" name="nom"
                                           placeholder="Rechercher une maison" onclick="showSuggestions()" readonly>
                                ...
                                <ul id="suggestionList" class="list-group mt-2 shadow"
                                    style="display: none; position: absolute; width: 100%; max-height: 200px; overflow-y: auto; z-index: 999;">
                    ...
                    <div class="navbar-nav ml-auto py-0 d-lg-block">
                        @auth
                            <div class="btn-group px-0 profile">
                                <span class="nav-link profil-name dropdown-toggle {{ request()->routeIs('profil.settings') ? 'text--primary' : '' }}"
                                      data-toggle="dropdown">
                                    {{ Auth::user()->name }}
                                </span>
                                <img src="{{ Auth::user()->avatar ? asset('storage/public/avatars/' . basename(Auth::user()->avatar)) : asset('img/noprofil.jpg') }}"
                                     alt="Profil" class="rounded-circle dropdown-toggle" data-toggle="dropdown">
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('profil.settings') }}">Paramètres</a>
